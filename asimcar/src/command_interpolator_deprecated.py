...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.current_to_torque_gain = rospy.get_param('/vesc/current_to_torque_gain')
        self.servo_smoother_rate = rospy.get_param('/vesc/servo_smoother_rate')
        ...
        self.max_delta_current = abs(self.current_to_torque_gain * self.max_jerk / self.throttle_smoother_rate)
